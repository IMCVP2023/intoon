				...
				<table class="table program_glance_table" name="1">
					...
					<tbody name="day" class="day_1 day_tbody">
						...
						<tr>
							...
							<td class="violet_bg pointer" name="satellite_symposium_1">
								Satellite Symposium 1
								<input type="hidden" name="e" value="room1">
							</td>
							<td class="violet_bg pointer" name="satellite_symposium_2">
					...
					<tbody name="day" class="day_tbody day_2">
						...
						<tr>
							...
							<td class="pink_bg pointer" name="luncheon_symposium_4">
