...
<div class="promotion_header">
	...
	<img src="./img/icons/welcome-1.png"/>
	<!-- <img src="./img/icons/IMCVP2024_Welcome-01.jpg"/> -->
</div>
								...
								<ul class="radio_list">
                                    <?php
                                        $conference_info_arr = array(
											"Register with an invitation code received by invitation from a KSCP Organizing Committee member."
                                        );
						...
						<tr class="">
							...
							<td>
								<ul class="half_ul" style="min-width:300px;justify-content :flex-start;">
									<li>
										<input type="text" placeholder="Invitation Code" name="promotion_code" value="IMCVPXKSCP001" disabled>
