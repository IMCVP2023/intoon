            ...
            <li>
                ...
                <div class="yellow_box">
                    ...
                    <div class="booked_box">
                        <div>
                            <h5>How to book</h5>
                            <h6><span>Step 1. </span>Download the reservation form</h6>
                ...
                <div>
                    ...
                    <ul>
                        <li>• Reservation is modifiable by 18:00PM on the 5-day before guest arrival.</li>
                        <li>• If guest fails to change or cancel before applied time on policy, one-night penalty charge will be applied.</li>
                        <li>• Check-in time is 15:00 and Check-out time is 11:00.</li>
                        <li>• Breakfast: KRW 50,500 (VAT included) / 1 person</li>
                    </ul>
                </div>
            </li>
			<!--2-->
              ...
              <li>
               ...
               <li>
                ...
                <div class="yellow_box">
                    <div class="booked_box">
                        <div>
                            <h6>Self-quarantine is only allowed in government-designated accommodations.</h6>
