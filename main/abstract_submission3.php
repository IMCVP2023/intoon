...
<section class="container submit_application">
    ...
    <div class="inner">
        <div class="section section1">
			...
			<img src="/main/img/2024_abstract_step3-1.png"/>
                <!-- <ul class="clearfix">
                    <li>
                        <p>STEP 01</p>
            ...
            <div class="input_area">
                <form name="abstract_form" class="abstract_form">
                    ...
                    <p style="color:#921004; font-weight:600; line-height:1.6;">To complete the submission, you must press the 'Submit'
                        button. <br>Failure to
                        do so will result in
                        incomplete processing.</p>
                    <div class="x_scroll">
...
window.onload = () => {
    alert(
        "To complete the submission, you must press the 'Submit' button. Failure to do so will result in incomplete processing."
    )
}
