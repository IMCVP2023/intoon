...
<header class="blue_header">
    <div class="g_h_top">
        <div class="container">
            ...
            <div class="g_h_logo"><img src="/main/img/2024_imcvp_logo-1.png" alt="" class="pointer"
                ...
                <ul class="depth01 clearfix">
                    ...
                    <li>
                        ...
                        <ul class="sub_nav">
                            ...
                            <li><a href="/main/abstract_submission_oral.php">Presentation<br>Guidelines</a></li>
                            <li><a href="/main/abstract_submission_award.php">Travel Grants</a></li>

                            <!-- <li><a href="/main/abstract_submission_guideline.php">Submission Guidelines</a></li>
                            <li><a href="/main/abstract_submission.php">Online
                                    Submission</a></li>
