						...
						<tr>
							...
							<td>
								<div class="max_normal">
									...
									?>
										<option data-nt="66" value="191"selected>Thailand</option>
						...
						<tr>
							...
							<td>
								<div class="max_normal phone">
									<input class="numbers" name="nation_tel" type="text" maxlength="60" readonly value="66">
                                    ...
                                    <li>
                                        <select id="category" name="category" class="required">
                                            ...
                                            foreach($category_arr as $a_arr) {
                                                $selected = $a_arr == "Pharmacist" ? "selected" : "";
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="chk_list info_check_list flex_center type2">
                                    ...
                                    <li>
                                        <input type="radio" class='new_radio' id="special_request1" name='special_request' value="0" <?= $prev["special_request_food"] === '0' ? "checked" : "checked" ?>/>
			...
			<div class="table_wrap detail_table_common x_scroll">
				<table class="table detail_table">
					...
					<tbody>
						<tr>
							<th>Total</th>
							<td><input type="text" id="reg_fee" name="reg_fee" style="border: none; background: transparent;" placeholder="0" readonly value="100"></td>
						</tr>
						<tr>
