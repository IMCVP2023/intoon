                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <input style="width: 12px;height:12px" type="checkbox"
                                            class="checkbox check_age" id="travel_grants_yn" name="travel_grants_yn"
                                            <?= $travel_grants_y_flag ? "checked" : "" ?>>
                                        <label for="travel_grants_yn" style="font-size: 24px; font-weight:700">Apply for
                                            IMCVP 2024
                                            Travel Grants</label>
                                        <span class="eligibility_open pointer"
                                        ...
                                        <div class="citation_box">
                                            <div class="file_input file_submission">
                                                ...
                                                <input type="file" name="prove_age_file" class="abstract_file"
                                                    accept=".jpeg, .jpg, .gif, .bmp, .png" data-idx="<?= $idx ?>">
                                                <span class="add_btn btn dark_gray_btn">File Find</span>
                                                <span class="add_btn btn dark_gray_btn delete_file">Delete</span>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
