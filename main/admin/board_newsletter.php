                    ...
                    <table id="datatable" class="list_table">
                        ...
                        <tbody>
							<?php
								...
								?>
									<tr class='tr_center'>
										<td><a href='./board_detail.php?t=<?=$board_type?>&i=<?=$l["idx"]?>' class='ellipsis'><?=stripslashes($l["title_en"])?></a></td>
										<td><a href='./board_detail.php?t=<?=$board_type?>&i=<?=$l["idx"]?>' class='ellipsis'><?=stripslashes($l["title_ko"])?></a></td>
										<td><?=$l["name"]?></td>
										<td><?=$l["view"]?></td>
                    ...
                    <table id="datatable" class="list_table">
                        ...
                        <tbody>
                            <?php
								...
								?>
									<tr class='tr_center'>";
										<td><a href='./board_detail.php?t=<?=$board_type?>&i=<?=$l["idx"]?>&c=<?=$category_id?>' class='ellipsis'><?=stripslashes($l["title_en"])?></a></td>";
										<td><a href='./board_detail.php?t=<?=$board_type?>&i=<?=$l["idx"]?>&c=<?=$category_id?>' class='ellipsis'><?=stripslashes($l["title_ko"])?></a></td>";
										<td><?=$l["register_date"]?></td>";
									</tr>";
							<?php
                                }
